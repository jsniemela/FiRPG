...
{
	pm.addCharacters(new Character("Player1", 100, 15, 3, 7, 2, 25, 10, true));
	pm.addCharacters(new Character("Player2", 100, 13, 3, 7, 2, 25, 8, false));
	pm.addCharacters(new Character("Player3", 100, 13, 3, 7, 2, 25, 8, false));
	em.addCharacters(new Character("Enemy1", 100, 12, 3, 7, 2, 25, 12, false));
	em.addCharacters(new Character("Enemy2", 100, 12, 5, 7, 2, 25, 6, false));
	em.addCharacters(new Character("Enemy3", 100, 12, 5, 7, 2, 25, 6, false));
}
